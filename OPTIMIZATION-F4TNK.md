...
| Étape | Kernels utilisés |
|---|---|
| AGC / normalisation | `magnitude_squared`, `magnitude` |
| Filtre canal (BPF 15 kHz) | `dot_prod_32f`, `dot_prod_32fc` |
| Correction Doppler (~±3 kHz) | `rotator2` |
| Synchronisation symbole (Gardner) | `magnitude_squared`, `dot_prod_32fc` |
| Détection seuil BPSK | `magnitude_squared`, `binary_slicer` |
| Viterbi K=7 (AX.25) | `conv_k7_r2` |
...
> 📝 *Document créé le 19 Février 2026 — Branche `master-f4tnk`*  
